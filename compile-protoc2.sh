...
# Builds protoc executable into target/<OS>/<ARCH>/protoc; optionally builds
# protoc plugins into target/<OS>/<ARCH>/protoc-gen-*
#
...
#   linux  linux   aarch64  Requires: g++-aarch64-linux-gnu
#   linux  linux   x86_32
#   linux  linux   x86_64
